...
function executeOperation(HeraldAdmin $client, string $op, array $inp): mixed {
    return match ($op) {
        ...
        'presence.getUser' => $client->chat->presence->getUser($inp['user_id']),
        'presence.getStream' => $client->chat->presence->getStream($inp['stream_id']),
        'presence.getCursors' => $client->chat->presence->getCursors($inp['stream_id']),
