/* @ts-self-types="./herald_e2ee_wasm.d.ts" */
...
export class Session {
    ...
    blind(plaintext) {
        ...
        try {
            ...
            const ret = wasm.session_blind(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    decrypt(ciphertext, room_id) {
        ...
        try {
            ...
            const ret = wasm.session_decrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    encrypt(plaintext, room_id) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(room_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.session_encrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
     ...
     */
    exportCipherKey() {
        const ret = wasm.session_exportCipherKey(this.__wbg_ptr);
     ...
     */
    exportVeilKey() {
        const ret = wasm.session_exportVeilKey(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
 ...
 * @returns {Session}
 */
export function createSession(shared_secret, version) {
    const ptr0 = passArray8ToWasm0(shared_secret, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.createSession(ptr0, len0, version);
    if (ret[2]) {
 ...
 * @returns {Uint8Array}
 */
export function deriveSharedSecret(my_secret, their_public) {
 ...
 * @param {Uint8Array} cipher_key_bytes
 * @param {Uint8Array} veil_key_bytes
 * @param {number} version
 * @returns {Session}
 */
export function restoreSession(cipher_key_bytes, veil_key_bytes, version) {
    const ptr0 = passArray8ToWasm0(cipher_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(veil_key_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.restoreSession(ptr0, len0, ptr1, len1, version);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return Session.__wrap(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./herald_e2ee_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('herald_e2ee_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
